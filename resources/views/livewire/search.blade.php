        ...
        <div class="search-overlay-top shadow-sm">
            <div class="container container--narrow">
                ...
                <input
                    ...
                    wire:model.live.debound.750ms='searchTerm' autocomplete="off" type="text" id="live-search-field"
            ...
            <div class="container container--narrow py-3">
                ...
                <div class="live-search-results live-search-results--visible">
                    @if (count($results) == 0 && $searchTerm !== '')
                        <p id='no-results' class='alert alert-danger text-center shadow-sm'>Sorry, we cannot find any
                    ...
                    <div class="list-group shadow-sm">
                        @foreach ($results as $post)
                            <a x-on:click.prevent="isOpen = false; Liveware.navigate('/post/{{ $post->id }}')"
